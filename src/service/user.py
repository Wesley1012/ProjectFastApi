...
def verify_password(plain: str, hash: str) -> bool:
    """Хеширование строки plain и сравнение с hash из БД"""
...
def get_current_user(token: str) -> User | None:
    """Декодирование токена доступа OAuth и возрат объекта User"""
...
def lookup_user(username: str) -> User | None:
    """Возврат совпадающего пользователя из БД для строки name"""
